...
class TestPackageIntegration(unittest.TestCase):
    def setUp(self):
        ...
        self.X_binary, self.X_binary_test, self.y_binary, self.y_binary_test = train_test_split(
    ...
    def test_classification_direct_import(self):
        try:
            ...
            scores, predictions = classifier.fit(self.X_class, self.X_class_test, self.y_class, self.y_class_test)
            ...
            scores_df, predictions_df = classifier.fit(
                self.X_class_df, self.X_class_test_df, self.y_class, self.y_class_test
            )
    ...
    def test_regression_direct_import(self):
        try:
            ...
            # Test with numpy arrays
            scores, predictions = regressor.fit(self.X_reg, self.X_reg_test, self.y_reg, self.y_reg_test)
    ...
    def test_custom_metrics(self):
        try:
            ...
            scores, predictions = classifier.fit(self.X_binary, self.X_binary_test, self.y_binary, self.y_binary_test)
